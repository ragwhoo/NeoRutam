      ...
      <div className="w-full text-center relative z-10">
        ...
        >
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-3 rounded-xl border border-[#fdffee]/20 px-8 py-4 text-[#fdffee] transition-colors hover:bg-[#365F37]/50 sm:w-auto"
          >
